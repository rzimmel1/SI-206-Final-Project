...
def fetch_weather_data(latitude, longitude):
    ...
    print(f"Precipitation Data: {hourly_precipitation}")
...
# Function to calculate and store average weather data
...
def main():
    ...
    for city in cities:
        ...
        # Fetch existing row count for the specific city from the database
        conn = sqlite3.connect('weather_data.db')
        c = conn.cursor()
        ...
        if existing_row_count < 100:
            ...
            print(data_chunk.head())  # Print first few rows to verify data
